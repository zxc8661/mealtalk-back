...
import com.mealtalk.api.global.error.SecurityErrorResponder;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Filter-chain failures bypass @RestControllerAdvice, so they get the
            // same JSON error body from a dedicated responder.
